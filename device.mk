...
$(call inherit-product-if-exists, vendor/lineage/config/common_mini_tablet_wifionly.mk)
$(call inherit-product-if-exists, vendor/bliss/config/common_mini_tablet_wifionly.mk)
